        ...
        <div>
            <Wrapper className="wrapper">
                <div className="sub_wrap sub_wrap04">
                    ...
                    <a href="add_liquidity.html" className="add_btn">Add Liquidity</a>
                        ...
                        <div id="jsLiquidityBox">
                            ...
                            <div className="box box_in">
                                <div className="loaded_txt">
                                    <p className="etu">
                                        <span className="icon01"><img src="../assets/images/ico/ico_eth01.png"
                                            alt="" /></span>
                                        <span className="icon02"><img src="../assets/images/ico/ico_eth02.png"
                                            alt="" /></span>
										ETU/USDT
									</p>
                                    <dl>
